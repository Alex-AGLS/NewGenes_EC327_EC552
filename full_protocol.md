...
| 2 | BBa_C0062 | coding sequence |
| 3 | BBa_B0015 | terminator |

## Step 1: PCR amplification (generated upstream)

protocol:
 1. Assemble all reaction components on ice.
...
2. Quickly transfer the reactions to a thermocycler preheated to the denaturation temperature (98 degrees celcius) and begin thermocycling.
3. Cycle forward primer (aatgtttagcgtgggcatgc) and reverse primer (gcgttcaccgacaaacaaca) 56.16 seconds with melting temperatures 81.31, see details in summary table.
