...
from scrape import *
from request_primer import *
import json
import csv


def get_table(xml_path, csv_path) -> None:
    results = ""
    result_ls = []
    json_path = "data.json"
...
def get_pcr_info(json_path, txt_path, csv_path) -> str:
    ...
    return get_template(temp, time, forward, reverse, txt_path)
